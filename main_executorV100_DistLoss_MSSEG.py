...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name",
                        default="trial_ProbU3Dv2_At0",
                        help="Name of the model")
    parser.add_argument("--dataset_path",
                        default="/home/schatter/Soumick/FranziVSeg/MSSEG_Organised/FLAIR_Fold0",
    ...
    parser.add_argument("--output_path",
                        default="/home/schatter/Soumick/FranziVSeg/Output/MSSeg_FLAIR_Fold0",
